...
describe('v1.ServiceManagerClient', () => {
    ...
    describe('getService', () => {
        it('invokes getService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetServiceRequest', ['serviceName']);
    ...
    describe('getServiceConfig', () => {
        it('invokes getServiceConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetServiceConfigRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetServiceConfigRequest', ['configId']);
    ...
    describe('createServiceConfig', () => {
        it('invokes createServiceConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateServiceConfigRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const expectedHeaderRequestParams = `service_name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.api.Service()
    ...
    describe('getServiceRollout', () => {
        it('invokes getServiceRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetServiceRolloutRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetServiceRolloutRequest', ['rolloutId']);
    ...
    describe('deleteService', () => {
        it('invokes deleteService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteServiceRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const expectedHeaderRequestParams = `service_name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('undeleteService', () => {
        it('invokes undeleteService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UndeleteServiceRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const expectedHeaderRequestParams = `service_name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('submitConfigSource', () => {
        it('invokes submitConfigSource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SubmitConfigSourceRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const expectedHeaderRequestParams = `service_name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createServiceRollout', () => {
        it('invokes createServiceRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateServiceRolloutRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const expectedHeaderRequestParams = `service_name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listServiceConfigs', () => {
        it('invokes listServiceConfigs without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListServiceConfigsRequest', ['serviceName']);
            request.serviceName = defaultValue1;
    ...
    describe('listServiceRollouts', () => {
        it('invokes listServiceRollouts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListServiceRolloutsRequest', ['serviceName']);
            request.serviceName = defaultValue1;
            const expectedHeaderRequestParams = `service_name=${defaultValue1}`;const expectedResponse = [
