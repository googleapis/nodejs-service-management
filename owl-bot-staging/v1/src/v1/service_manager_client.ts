 ...
 */
  enableService(
    ...
    this.initialize();
    this.warn('DEP$ServiceManager-$EnableService','EnableService is deprecated and may be removed in a future version.', 'DeprecationWarning');
 ...
 */
  disableService(
    ...
    this.initialize();
    this.warn('DEP$ServiceManager-$DisableService','DisableService is deprecated and may be removed in a future version.', 'DeprecationWarning');
